...
test('生产入口兼容旧版 #实验ID 深链接', async ({ page }) => {
  ...
  await expect(page).toHaveURL(/\/dist\/index\.html#NT06$/);
...
test('生产包历史入口回退到共享旧壳且不请求音频', async ({ page }) => {
  const mediaRequests = [];
...
test('PR02 明确区分有限计算与未解决猜想', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/PR02', { waitUntil: 'domcontentloaded' });
...
test('PR03 原生实验复现 c≤1000 的 158 组计数', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/PR03', { waitUntil: 'domcontentloaded' });
...
test('PR04 纠正点接触相邻规则的错误上界', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/PR04', { waitUntil: 'domcontentloaded' });
...
test('PR05 精确枚举证明 K6 没有可避开染色', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/PR05', { waitUntil: 'domcontentloaded' });
  await page.getByRole('tab', { name: /枚举/ }).click();
  await expect(page.getByRole('row', { name: /K6 32,768 0 0\.0000%/ })).toBeVisible();
});

test('PR06 准确列出 100 的六个不重复素数分拆', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/PR06', { waitUntil: 'domcontentloaded' });
...
test('PR07 准确给出一万以内 205 对孪生素数', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/PR07', { waitUntil: 'domcontentloaded' });
...
test('PR08 展示 96 边形给出的 π 上下界', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/PR08', { waitUntil: 'domcontentloaded' });
...
test('SQ01 明确斐波那契下标与不完整整除命题', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/SQ01', { waitUntil: 'domcontentloaded' });
...
test('GM01 区分凸多边形扇形切法与一般三角剖分', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/GM01', { waitUntil: 'domcontentloaded' });
...
test('GR01 的完整判据包含连通性', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/GR01', { waitUntil: 'domcontentloaded' });
...
test('PB01 披露 50.73% 的模型假设', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/PB01', { waitUntil: 'domcontentloaded' });
...
test('AL04 修正 64 盘耗时数量级', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/AL04', { waitUntil: 'domcontentloaded' });
...
test('SQ07 修正杨辉三角奇数项个数公式', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/SQ07', { waitUntil: 'domcontentloaded' });
  await page.getByRole('tab', { name: /奇偶/ }).click();
...
test('GM03 只在固定周长下比较等边最大面积', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/GM03', { waitUntil: 'domcontentloaded' });
...
test('GR07 用精确公式替代错误的随机桶碰撞模拟', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/GR07', { waitUntil: 'domcontentloaded' });
...
test('PB02 明确主持人协议并删除伪贝叶斯推导', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/PB02', { waitUntil: 'domcontentloaded' });
...
test('AL07 修正 4 亿规模和 JavaScript 位运算中点', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/AL07', { waitUntil: 'domcontentloaded' });
...
test('SQ09 用拼图和代数证明连续三角数恒等式', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/SQ09', { waitUntil: 'domcontentloaded' });
...
test('GM04 修正球内接正方体边长与最优条件', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/GM04', { waitUntil: 'domcontentloaded' });
...
test('GR02 区分精确最短路线与最近邻启发式', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/GR02', { waitUntil: 'domcontentloaded' });
  await page.getByRole('tab', { name: /规模/ }).click();
...
test('PB03 先披露二项模型条件再讨论近似', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/PB03', { waitUntil: 'domcontentloaded' });
...
test('AL01 用精确有理数找到分数解并修正枚举数量', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/AL01', { waitUntil: 'domcontentloaded' });
...
test('SQ04 修正三对括号枚举并明确计数对象', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/SQ04', { waitUntil: 'domcontentloaded' });
...
test('GM07 用合法环面胞腔分解得到 χ=0', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/GM07', { waitUntil: 'domcontentloaded' });
...
test('GR09 展示度数和与边数的双重计数', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/GR09', { waitUntil: 'domcontentloaded' });
...
test('PB08 区分灵敏度与阳性预测值', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/PB08', { waitUntil: 'domcontentloaded' });
...
test('AL10 从 p² 开始筛并修正十亿以内素数个数', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/AL10', { waitUntil: 'domcontentloaded' });
...
test('NT01 修正完全数范围、定理归属与当前记录', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/NT01', { waitUntil: 'domcontentloaded' });
  await page.getByRole('tab', { name: /搜索/ }).click();
...
test('FR03 区分无限边界、有限区域与不准确现实类比', async ({ page }) => {
  await page.goto('/dist/index.html#/experiment/FR03', { waitUntil: 'domcontentloaded' });
...
for (const width of [360, 390, 768]) {
  ...
  test(`三十个原生实验全部阶段在 ${width}px 无横向溢出`, async ({ page }) => {
    ...
    for (const experimentId of NATIVE_EXPERIMENT_IDS) {
      await page.goto(`/dist/index.html#/experiment/${experimentId}`, { waitUntil: 'domcontentloaded' });
...
test('新应用目录与详情页无严重无障碍问题', async ({ page }) => {
  for (const path of [
    '/dist/index.html',
    '/dist/index.html#/experiment/PR01'
  ]) {
